...
Session id: unknown
Generated: 2026-06-24T12:25:47Z
Goal: let's pick option C, works as the best of both worlds. If we have enough data, we use isotonic, else if we have a rare class, we switch to sigmoid
